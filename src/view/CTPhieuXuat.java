...
public class CTPhieuXuat extends javax.swing.JDialog {
    ...
    public void loadDataToTableProduct() {
        try {
            ArrayList<ChiTietPhieuXuat> CTPhieu = ChiTietPhieuXuatDAO.getInstance().selectAll(this.parent.getPhieuXuatSelect().getMaphieu());
    ...
    private void initComponents() {
        ...
        jPanel1.add(labelTongTien, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 450, 203, -1));
        ...
        jPanel1.add(labelMaPhieu, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 100, 242, -1));
        ...
        jPanel1.add(labelNguoiTao, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 130, 234, -1));
        ...
        jPanel1.add(labelThoiGianTao, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 130, 242, -1));
